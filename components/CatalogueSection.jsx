  ...
  const items = [
    {
      ...
      description:
        "family Bedroom  with a clean and comfortable design for your family",
    },
    {
      id: "02",
      ...
      description: "Family Kitchen with a beautiful design",
    },
    {
      id: "03",
    ...
    },
    {
      ...
      description:
        "family Living  with a clean and comfortable design for your family",
    },
  ];
  return (
    <div className=" grid gap-8 lg:grid-cols-4 md:grid-cols-2 lg:gap-0 divide-gray-300 lg:divide-x">
      {items.map((item) => (
        <div key={item.id} className=" relative overflow-hidden group">
          ...
          <div
            className=" inset-0 bg-orange-500 flex-col items-center justify-end md:flex
           md:absolute gap-32 pb-16 text-xl transition duration-300 ease-in-out border-b-2 group-hover:translate-y-full md:border-b-0 hidden"
          >
